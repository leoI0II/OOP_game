...
Tile::Tile(double x = 0, double y = 0) : Point(x, y) {}
Tile::Tile(const Point& point) : Point(point) {}
Tile::Tile(const Point& point, Type tp, Status st = Status::NotAvailable) : Point(point), type(tp), status(st) {}
Tile::Tile(double x, double y, Type tp, Status st = Status::NotAvailable) : Point(x, y), type(tp), status(st) {}
