...
Enemy1::Enemy1(int HP, int dmg, const Point& point, double sp, MoveDir ms, EnemyType tp)
    : Enemy(HP, dmg, point, sp, ms, tp) {}
...
Enemy2::Enemy2(int HP, int dmg, const Point& point, double sp, MoveDir ms, EnemyType tp)
    : Enemy(HP, dmg, point, sp, ms, tp) {}
...
Enemy3::Enemy3(int HP, int dmg, const Point& point, double sp, MoveDir ms, EnemyType tp)
    : Enemy(HP, dmg, point, sp, ms,tp) {}
